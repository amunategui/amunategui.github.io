...
In this class you learn how to use R in a distributed environment, create Spark clusters on Amazon's AWS, 
perform distributed modeling using GLM,
measure distributed regression and classification predictions,
access data from csv's, json, hdfs, and S3. <BR>
...
<img src="{{site.baseurl}}/img/quantmod-r-25.png" alt="Quantmod and R" style='padding:2px; border:1px solid #021a40;' align="bottom" hspace="20">18 lectures on 'Quantmod and R' available at Udemy.com<</a>
</p>
