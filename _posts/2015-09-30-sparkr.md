---
layout: post
title: "Supercharge R with Spark: Getting Apache's SparkR Up and Running on Amazon Web Services (AWS)" 
...
day: 30
published: true
summary: "See how easy it is to set up a few SparkR clusters and to control them from RStudio. In this first installment, we'll set up multiple clusters on Amazon's AWS EC2 and control them via RStudio."
...
# handy command to kill all Spark clusters (this won't remove the first instance created to lauch the clusters)
./spark-ec2 -k demo -i demo.pem -r us-west-2  destroy my-spark-clusterv
