...
Just a quick <a href='https://spark.apache.org/docs/latest/sparkr.html' target='_blank'>example</a> to show that this works. Paste the following code into RStudio running on your master cluster:
