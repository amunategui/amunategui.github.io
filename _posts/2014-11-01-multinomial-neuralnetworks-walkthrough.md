...
day: 1
published: true
summary: Using R and the <b>multinom</b> function from the <b>nnet</b> package, we can easily predict discrete values (factors) of more than <b>2</b> levels. We also use <b>Repeated Cross Validation</b> to get an accurate model score and to understand the importance of allowing the model to <b>converge</b> (reaching global minima).
