...
day: 27
published: true
summary: "See how easy it is to install H2O and RStudio Server on Amazon Web Services (AWS) from scratch. No need of customized AMIs or thrid party tools - no training wheels here! And the best part is that we can do everything from the Amazon Web Service wizard, no need to tunnel or putty anywhere!"
image: h2o-on-aws/amzon-river.png
---
...
**Resources**
<ul>
<li type="square"><a href="https://www.youtube.com/watch?v=n3oV9E4HzKE" target='_blank'>YouTube Companion Video</a></li>
...
<ul>
   ...
   <li type="square"><a href="#configure-instance">Step 3: Configure Instane Details</a></li>
...
<BR><BR>
<h2><a id="aws-instance">Setting up an AWS Instance</a></h2>
...
<h4><a id="configure-instance">Step 3: Configure Instane Details</a></h4>
<BR>
<p style="text-align:center">
<img src="../img/posts/h2o-on-aws/ec2-step3.png" alt="Configure Instane Details" style='padding:1px; border:1px solid #021a40; width: 75%; height: 75%'></p>
<br><br>
...
<BR><BR>
<p style="text-align:center">
<img src="../img/posts/h2o-on-aws/ec2-advanced.png" alt="Security Settings" style='padding:1px; border:1px solid #021a40; width: 75%; height: 75%'></p>
<br><br>
...
<BR>
Thant's it! We're over half-way there! Install the H2O package, initialize it and run some demos (check out the output of both demos to get familiar with some of the modeling commands)
